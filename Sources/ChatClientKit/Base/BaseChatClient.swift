...
open class BaseChatClient: ChatClient, @unchecked Sendable {
    ...
    open func provideStreamingChat(body: ChatRequestBody) async throws -> AnyAsyncSequence<ChatResponseChunk> {
    ...
    open func extractConnectionError(from response: Data?, statusCode: Int) -> String {
